import json
file_k_paths = './RoutingGeant/DRL/dRSIR/48nodos/k_paths.json'
# file_k_paths = './RoutingGeant/DRL/dRSIR/32nodos/k_paths.json'
# file_k_paths = './RoutingGeant/DRL/dRSIR/topos/topo_32_nodes_k_20_paths.json'
