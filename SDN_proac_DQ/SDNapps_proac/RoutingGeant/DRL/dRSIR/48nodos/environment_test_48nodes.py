...
class Environment(object):
    ...
    def rewards_sintetic(self):
        file_topo = './RoutingGeant/DRL/dRSIR/topos/topo_48.json'
        file_k_paths = './RoutingGeant/DRL/dRSIR/topos/topo_48_nodes_k_20_paths.json'
    ...
    def path_metrics_to_reward(self):
        ...
        # ini = time.time()
        # file = './RoutingGeant/DRL/dRSIR/48nodos/paths_metrics.json' #para probar ocvergencia
        print('reading paths_metrics')
        file = './paths_metrics.json' #para rodar trafico final
