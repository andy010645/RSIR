...
#---------------------FLOW INSTALLATION MODULE FUNCTIONS ----------------------------
    ...
    def get_k_paths(self):
        i = time.time()
        # file = './k_paths.json'
        # file = './RoutingGeant/DRL/dRSIR/64nodos/k_paths.json'
        # file = './RoutingGeant/DRL/dRSIR/48nodos/k_paths.json'
        # file = './RoutingGeant/DRL/dRSIR/32nodos/k_paths.json'
        file = './RoutingGeant/DRL/dRSIR/23nodos/k_paths.json'
    ...
    def get_dRL_paths(self):
        ...
        # file = './RoutingGeant/DRL/dRSIR/48nodos/fffpaths_weight.json'
        # file = './RoutingGeant/DRL/dRSIR/32nodos/fffpaths_weight.json'
        # file = './drl_paths.json'
        file = './rl_paths.json'
        # file = './rl_paths23.json'
        # file = './drl_paths23.json'
        try:
            with open(file,'r') as json_file:
